...
> > - 사람의 팔
> >
> > - 멀티 스레드 작업을 지원을 잘 하면 다중 코어, 다중 스레드를 사용하는게 중요 옵션(내가 무슨 일을 하는지)
>
> ### 클럭
>
> > - 얼마나 빠른 속도로 일을 할 수 있나
> >
> > - 스레드 하나가 동작하는 일이면 스레드 수가 아니라 클럭이 중요
>
> #### 캐시 메모리
>
> > - CPU안에 포함되어 있음
> > - 굉장히 속도가 빠르고 비쌈(용량대비 가격)
> > - 모든 데이터를 항상 캐시메모리에서 처리할 필요 없으니까 비교적 가끔 들어가는 것은 메모리에 저장, 그것보다 더 가끔 사용하면 대용량장치에 저장
>
> #### 메모리(RAM)
>
> > - 속도가 적당히 빠르고 적당히 비쌈
...
>
> > - 속도가 비교적 느리고 가장 쌈
> > - 항상 빠르게 처리할 필요가 없는 작업은 여기서 처리해도 됨
